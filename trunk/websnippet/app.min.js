...
(function() {
    //console.log((1 - $("#header").outerHeight()/$("#content").height())*100);
    //set the height for main content by calculating the %
    //$("#mainContent").height((100 - (($("#header").outerHeight()/$("#content").height())*100)) + "%");
    ...
    //setting the height of the editors
    //$("#topDecoration").css("height","89%");//.height("90%");
    //$("#top-component .CodeMirror").height("100%");

    //$("#innerTopDecoration").height("89%");
    //$("#innerTopDecoration .CodeMirror").height("100%");

    //$("#innerBottomDecoration").height($("#inner-bottom-component").height() - 20);
    //$("#innerBottomDecoration .CodeMirror").height($("#inner-bottom-component").height() - $("#run").outerHeight() - 25);
