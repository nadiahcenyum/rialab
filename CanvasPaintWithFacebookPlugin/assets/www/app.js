...
function setCanvasDmiension() {
    ...
    canvas.setAttribute('height', window.innerHeight - document.getElementById("controls").offsetHeight - 22); //300
}
...
function sendEmailTo(){
	window.plugins.emailComposer.showEmailComposerWithCallback(null,"My Latest Canvas Painting....","<b>This is my latest painting with the canvas paint app...:</b><p>" + imgUrl + "</p>",["jsphkhan@gmail.com","nandakumar@goldspotmedia.com"],[],[],true,[]);
}
